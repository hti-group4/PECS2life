 ...
 */
public class PECSCardAdapter2 extends RecyclerView.Adapter<PECSCardAdapter2.ViewHolder> {
     ...
     */
    PECSCardAdapter2(Context context, ArrayList<PECSCard> mPECSCards) {
    ...
    @NonNull
    @Override
    public PECSCardAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull PECSCardAdapter2.ViewHolder holder, int position) {
